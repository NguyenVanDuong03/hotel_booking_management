        ...
        <div class="page-title-box d-flex align-items-center justify-content-between">
            ...
            <div class="page-title-right">
                <ol class="breadcrumb m-0">
                    ...
                    <li class="breadcrumb-item active"><a href="{{route('hotels.index', ['pageIndex' => $pageIndex])}}">Danh sách phòng</a></li>
...
<div class="row mt-5">
    ...
    <div class="col-xl-2"></div>
    <div class="col-xl-10">
        <p class="d-flex justify-content-end"><a href="{{route('hotels.index', ['pageIndex' => $pageIndex])}}" class=""><button class="btn btn-primary fw-bold">Quay lại</button></a></p>
    </div>
</div>
@endsection
