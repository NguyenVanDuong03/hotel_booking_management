        ...
        <div class="page-title-box d-flex align-items-center justify-content-between">
            ...
            <div class="page-title-right">
                <ol class="breadcrumb m-0">
                    ...
                    <li class="breadcrumb-item active"><a href="{{url('hotels?pageIndex'.$pageIndex)}}">Danh sách phòng</a></li>
...
<div class="container mt-5">
    <div class="row">
        <div class="col-12">
            <div class="card">
                <div class="card-body">
                    <form class="needs-validation" novalidate method="POST" action="{{route('hotels.update', ['hotel' => $hotel->hotel_id, 'pageIndex' => $pageIndex])}}">
                        @csrf
                        @method('PUT')
                        ...
                        <div class="d-flex justify-content-end my-3">
                            ...
                            <a href="{{url('hotels?pageIndex'.$pageIndex)}}" class="btn btn-danger waves-effect waves-light">Quay
                                lại</a>
                        </div>
                    </form>
