                    ...
                    <div class="row">
                        ...
                        <div class="col-lg-7">
                            <div class="p-5">
                                ...
                                <p class="text-muted mb-4">Nhập địa chỉ email và mật khẩu của bạn để truy cập vào trang quản trị.</p>
                                        ...
                                        <div class="col-12 text-center">
                                            <p class="text-muted mb-2">
                                                @if (Route::has('password.request'))
                                                    <a class="btn btn-link text-muted font-weight-medium ml-1" href="{{ route('password.request') }}">
                                                        {{ __('Quên mật khẩu?') }}
                                                    </a>
                                                @endif
                                            </p>
