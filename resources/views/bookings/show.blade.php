...
@section('content')
                ...
                <div class="page-title-right">
                    <ol class="breadcrumb m-0">
                        ...
                        <li class="breadcrumb-item active"><a
                                href="{{ route('bookings.index', ['pageIndex' => $pageIndex]) }}">Danh sách đặt phòng</a>
                        </li>
    ...
    <div class="row mt-5">
                ...
                <div class="table-responsive">
                    <table class="table mb-0">
                        ...
                        <tbody>
                            ...
                            <tr>
                                <th scope="row">Ngày nhận phòng</th>
                                <td>{{ $booking->booking_checkin }}</td>
                            </tr>
                            <tr>
        ...
        <div class="col-xl-2"></div>
        <div class="col-xl-10">
            <p class="d-flex justify-content-end"><a href="{{ route('bookings.index', ['pageIndex' => $pageIndex]) }}"
